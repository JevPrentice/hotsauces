package com.spiderwalk.hotsauces.controller

import com.spiderwalk.hotsauces.db.HotSauceRepository
...
class HotSauceController(private val hotSauceRepository: HotSauceRepository) {
    ...
    fun createHotSauce(@RequestBody hotSauce: HotSauce): ResponseEntity<HotSauce> {
        return ResponseEntity(hotSauceRepository.save(hotSauce), HttpStatus.OK)
    }
